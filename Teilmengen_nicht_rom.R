...
gv <- gv + geom_point(aes(x = lng , y = lat), colour = "#377eb8", data = df_insch, alpha = 0.35) +
  ggtitle("Vergleich von gem_vor mit den lat. Inschriften")

ggsave("gem_vor.png", plot = gv , width = 16, height = 10, units = "cm")
...
gv2 <- gv2 + geom_point(aes(x = lng , y = lat), colour = "#377eb8", data = df_insch, alpha = 0.35) +
  ggtitle("Vergleich von gem_vor mit den lat. Inschriften")
...
gl <- gl + geom_point(aes(x = lng , y = lat), colour = "#377eb8", data = df_insch, alpha = 0.35) +
...
gl2 <- gl2 + geom_point(aes(x = lng , y = lat), colour = "#377eb8", data = df_insch, alpha = 0.35) +
  ggtitle("Vergleich von gem_lat mit den lat. Inschriften")
...
sv <- sv + geom_point(aes(x = lng , y = lat), colour = "#377eb8", data = df_insch, alpha = 0.35) + 
...
sl <- sl + geom_point(aes(x = lng , y = lat), colour = "#377eb8", data = df_insch, alpha = 0.35) + 
...
sl2 <- sl2 + geom_point(aes(x = lng , y = lat), colour = "#377eb8", data = df_insch, alpha = 0.35) + 
