...
#plot für alle Aktionen über 2 Tage für alle 43 Aktionen (Code fehlt noch; ist unvollständig)
alle_aktionen <- dfpubresults[order(dfpubresults$pubresults, decreasing = TRUE),][1:43,]
alle_aktionen$title <- c("Dialekt Themenwoche im BR (27.04.2018)", "Artikel auf rosenheim 24.de (19.06.2018)", "Beitrag auf Facebookseite Servizio Minoranze (09.08.2019)", 
                    "Artikel auf zalp.ch (27.03.2017)", "Artikel auf lmu.de (15.05.2017)", "Bericht auf brennerbasisdemokratie.eu (30.07.2019)", 
